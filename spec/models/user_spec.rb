...
RSpec.describe User, type: :model do
  ...
  describe "favorite beer" do
    ...
    it "is the one with highest rating if several rated" do
      best = create_beer_with_rating(FactoryGirl.create(:brewery), FactoryGirl.create(:style), user, 25)
      create_beers_with_ratings(FactoryGirl.create(:brewery),  FactoryGirl.create(:style), user, 10, 20, 15, 7, 9)
  ...
  describe "favorite brewery" do
    ...
    it "is the brewery of only rated if only one rating" do
      ...
      beer = create_beer_with_rating(brewery, FactoryGirl.create(:style), user, 25)
    ...
    it "is the brewery with best average if many ratings" do
      ...
      create_beers_with_ratings(best, FactoryGirl.create(:style)  , user, 35, 45)
  ...
  describe "favorite style" do
    ...
    it "is the style of only rated if only one rating" do
      create_beer_with_rating(FactoryGirl.create(:brewery) , FactoryGirl.create(:style), user, 25)
    ...
    it "is the style with best average if many ratings" do
      ...
      create_beers_with_ratings(FactoryGirl.create(:brewery), FactoryGirl.create(:style, name:"dunkel"), user, 50, 10, 15, 20)
